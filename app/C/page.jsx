  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 lg:gap-12 items-start max-w-6xl px-4 mx-auto py-28">
      ...
      <div className="grid gap-4 md:gap-10 items-start order-1">
        <h1 className="font-bold text-3xl lg:text-4xl">KATAOMOI名刺C</h1>
        <div className="text-4xl font-bold">1,200円</div>
        <p className="text-lg text-gray-500 dark:text-gray-400">ここにKATAOMOI名刺Cの特徴が入ります。ここにKATAOMOI名刺Cの特徴が入ります。ここにKATAOMOI名刺Cの特徴が入ります。
        </p>
        ...
        <Link href ="https://nftticket-alpha-v1.myshopify.com/products/%E3%83%A9%E3%82%A4%E3%83%96%E3%83%81%E3%82%B1%E3%83%83%E3%83%88">
