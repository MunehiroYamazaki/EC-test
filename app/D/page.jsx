  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 lg:gap-12 items-start max-w-6xl px-4 mx-auto py-28">
      ...
      <div className="grid gap-4 md:gap-10 items-start order-1">
        <h1 className="font-bold text-3xl lg:text-4xl">KATAOMOI名刺D</h1>
        <div className="text-4xl font-bold">1,600円</div>
        <p className="text-lg text-gray-500 dark:text-gray-400">ここにKATAOMOI名刺Dの特徴が入ります。ここにKATAOMOI名刺Dの特徴が入ります。ここにKATAOMOI名刺Dの特徴が入ります。
        </p>
